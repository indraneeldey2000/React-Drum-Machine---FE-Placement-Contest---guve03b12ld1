  ...
  return (
    <div id='control-screen'>
      <label id='label-power'>
        <input type='checkbox' id='power' checked = {power} onChange={handlePowerToggle}/>
        <span className='checkmark'>{power ? "Power ON" : "Power OFF"}</span>
      </label>
      <label id='label-volume'>
        <input type='range'  id='volume' min="0" max="1" step="0.01" value={volume} onChange={handleVolumeChange} disabled={!power} />
